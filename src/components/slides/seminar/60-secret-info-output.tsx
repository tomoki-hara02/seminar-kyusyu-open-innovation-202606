...
export default function Slide60SecretInfoOutput() {
  return (
    <SlideWrapper>
      <motion.div
        className="flex flex-col gap-4 md:gap-5 w-full max-w-6xl h-full justify-center py-4 md:py-5"
