              ...
              {section.items.map((item) => (
                <li
                  ...
                  style={{
                    ...
                    color: item.highlight ? OVERSEAS_ACCENT : 'rgba(255,255,255,0.62)',
...
export default function Slide45DataResidencyPatterns() {
  return (
    <SlideWrapper>
      <motion.div
        className="flex flex-col gap-2.5 md:gap-3 w-full max-w-6xl pt-8 min-h-0 flex-1"
