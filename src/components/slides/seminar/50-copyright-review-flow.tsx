...
/**
 * p50: 4-6 著作物 — プロンプトに他人の制作物を入力する際の検討フロー
 *
...
export default function Slide49CopyrightReviewFlow() {
  ...
  return (
    <SlideWrapper>
      ...
      >
        ...
        <div className="flex flex-col items-center flex-1 min-h-0 justify-center py-1">
          {STEPS.map((step, i) => (
