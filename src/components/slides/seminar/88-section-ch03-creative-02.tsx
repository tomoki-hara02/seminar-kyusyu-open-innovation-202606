...
/**
 * p88: Chapter 03 内 — クリエイティブ編 02（中間見出し / セクション扉）
 *
 * ベース: `84-section-ch03-sales-01.tsx`
 */

const SECTION_ACCENT = '#c8a8ff';
const LAW_ACCENT = '#ffaacc';

const SECTION = {
  number: '02',
  label: 'Part',
  title: 'クリエイティブ編',
  subtitle: 'クリエイター業務委託時と生成AIの法的問題について解説します。',
};

export default function Slide88SectionCh03Creative02() {
  return (
    <SlideWrapper>
      <motion.div
        ...
        <div className="flex shrink-0 items-center justify-center">
          <motion.span
            ...
            style={{
              ...
              background: `linear-gradient(160deg, ${SECTION_ACCENT} 0%, ${LAW_ACCENT} 55%, #88bbff 100%)`,
