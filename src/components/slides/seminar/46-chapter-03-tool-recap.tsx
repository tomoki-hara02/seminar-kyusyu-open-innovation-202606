...
/**
 * p46: Recap — 3 ツールで抑えるべきポイント
 *
 * ベーステンプレート: `templates/Recap.tsx`
 * （3-1 総論 / 3-2 端末 / 3-3 ツール・プラン / 3-4 MCP・エージェントのまとめ）
 */
...
export default function Slide46Chapter03ToolRecap() {
  return (
    <SlideWrapper>
      <motion.div
      ...
      >
        <div className="flex flex-col gap-2 shrink-0">
          ...
          >
            ...
            <span
              ...
              style={{
                backgroundImage: `linear-gradient(90deg, ${TOOL_ACCENT} 0%, #88bbff 50%, #ffaacc 100%)`,
              }}
            >
              抑えるべきポイント
            </span>
        ...
        >
          ※ 次は「4 入力情報」— データの権利関係・入力禁止情報へ進みます
        </p>
      </motion.div>
    </SlideWrapper>
  );
