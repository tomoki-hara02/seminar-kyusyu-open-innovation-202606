...
const LIMITATIONS = [
  ...
  { article: '第41条の2', title: '裁判手続等における複製等' },
  { article: '第42条', title: '立法又は行政の目的のための内部資料としての複製等' },
  { article: '第42条の2', title: '審査等の手続における複製等' },
  { article: '第42条の3', title: '行政機関情報公開法等による開示のための利用' },
  { article: '第42条の4', title: '公文書管理法等による保存等のための利用' },
  { article: '第43条', title: '国立国会図書館法によるインターネット資料及びオンライン資料の収集のための複製' },
...
export default function Slide62CopyrightLimitations() {
