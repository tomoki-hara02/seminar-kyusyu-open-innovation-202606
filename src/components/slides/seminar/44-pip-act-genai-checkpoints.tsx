...
/**
 * p44: 4-4 個人情報 — 個人情報保護法と生成AIの論点チェック
 *
...
const CHECKPOINTS = [
  {
    label: '個人情報の定義（vs 個人データ）',
    accent: LAW_ACCENT,
  },
  {
    label: '個人情報と利用目的（プライバシーポリシー）',
    accent: '#7dd3fc',
  },
  {
    label: '個人データを生成AIに入力する際の法律関係（データレジデンシー）',
    accent: CHAPTER_ACCENT,
  },
] as const;

export default function Slide43PipActGenaiCheckpoints() {
  return (
    <SlideWrapper>
      <motion.div
        className="flex flex-col gap-7 md:gap-8 w-full max-w-4xl pt-10 min-h-0 flex-1"
      ...
      >
        ...
        <div className="flex flex-col gap-3 md:gap-3.5 flex-1 justify-center">
