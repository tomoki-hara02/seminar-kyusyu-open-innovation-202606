...
/**
 * p86: 商談編 — Webミーティング・議事録AI（インフォグラフ）
 */
    ...
    >
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-0 w-full max-w-3xl">
        ...
        >
          ...
          <p className="font-bold text-white text-center" style={{ fontSize: 'clamp(12px, 1.05vw, 15px)' }}>
            Webミーティング
          </p>
          <span
...
export default function Slide86SalesMeetingAiCheckpoints() {
  return (
    <SlideWrapper>
      <motion.div
