...
/**
 * p40: 4-1 入力情報 総論 — データに付着する法的権利関係
 *
...
export default function Slide39InputDataLegalRights() {
  return (
    <SlideWrapper>
      <motion.div
        className="flex flex-col gap-2 md:gap-3 w-full max-w-6xl pt-8 min-h-0 flex-1"
