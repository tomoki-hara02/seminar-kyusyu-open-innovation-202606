...
/**
 * p42: 4-2 入力禁止情報 — リスクベースアプローチとの関係
 *
...
export default function Slide41RiskBasedInputRelationship() {
  ...
  return (
    <SlideWrapper>
      <motion.div
        ref={ref}
        className="flex flex-col gap-5 md:gap-6 w-full max-w-6xl pt-10 min-h-0 flex-1"
      ...
      >
        ...
        <div className="flex flex-col items-center flex-1 min-h-0 justify-center py-2">
          {STEPS.map((step, i) => (
