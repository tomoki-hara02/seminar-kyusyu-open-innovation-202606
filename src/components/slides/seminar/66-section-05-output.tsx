...
const SECTION = {
  ...
  title: '出力情報',
  subtitle:
    'AIの出力をどう確認し、どう取り扱うか — HITLと社内審査の運用を定めるパート。',
};

const TOPICS = [
  { num: '5-1', label: '出力情報 総論' },
  { num: '5-2', label: 'HITL（人間による確認）' },
  { num: '5-3', label: '認識の無い著作物の出力' },
  { num: '5-4', label: '秘密情報入力時の出力の扱い' },
  { num: '5-5', label: '社内外利用時の審査基準' },
];

export default function Slide66Section05Output() {
  return (
    <SlideWrapper>
      <motion.div
