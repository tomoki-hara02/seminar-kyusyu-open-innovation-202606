...
/**
 * p47: 4-4 個人情報 — 第28条（外国にある第三者への提供の制限）
 *
 * 上: 第28条1項（色分けハイライト）
...
function ExceptionGroup({
  ...
  return (
    <div
      className="flex flex-col items-center gap-1 rounded-lg border px-2 py-1.5 shrink-0"
      style={{
...
function RequirementsGroup({
  ...
  return (
    <div className="flex items-stretch shrink-0 lg:self-stretch">
      ...
      <div
        ref={boxRef}
        className="flex flex-col justify-center gap-1.5 rounded-xl border px-2.5 py-2 min-w-[11.5rem] md:min-w-[12.5rem] self-stretch"
        style={{
...
function EffectGroup() {
  return (
    <div className="flex items-stretch shrink-0">
      <BracketTag label="【効果】" />
      <div
        className="flex items-center rounded-xl border px-2.5 py-2 min-w-[11.5rem] md:min-w-[12.5rem]"
        style={{
          borderColor: `${LAW_ACCENT}55`,
          background: `${LAW_ACCENT}0a`,
        }}
...
function FlowDiagram() {
  ...
  return (
    <motion.div
      ref={diagramRef}
      className="relative w-full flex flex-col gap-3 shrink-0"
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row gap-3 lg:gap-4 lg:items-stretch">
        ...
        <div className="hidden lg:flex flex-1 min-w-0 gap-2 items-stretch">
          <div
            className="flex-1 grid grid-rows-3 gap-1.5 py-2"
            style={{ paddingLeft: 0 }}
          >
            <div aria-hidden />
      ...
      <div className="flex flex-col lg:flex-row gap-3 lg:gap-4 lg:items-start">
        <div className="flex flex-col items-center lg:items-start shrink-0">
          <FlowArrowDown className="hidden lg:block ml-[5.5rem]" />
          <EffectGroup />
        </div>

        <div className="flex flex-wrap items-center gap-1.5 min-w-0 flex-1 lg:pt-5">
...
export default function Slide46Article28ForeignThirdParty() {
  return (
    <SlideWrapper>
      <motion.div
        className="flex flex-col gap-2 md:gap-2.5 w-full max-w-6xl pt-6 min-h-0 flex-1"
