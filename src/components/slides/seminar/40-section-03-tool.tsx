...
const SECTION = {
  ...
  title: 'ツール',
  subtitle:
    'どのツール・端末・プラン・外部接続を許すか — シャドーAI対策の核となるパート。',
};

const TOPICS = [
  { num: '3-1', label: 'ツール総論' },
  { num: '3-2', label: 'アクセス可能な端末' },
  { num: '3-3', label: '使用可能なAIツール・プラン' },
  { num: '3-4', label: 'エージェント・MCPの取扱い' },
];

export default function Slide40Section03Tool() {
  return (
    <SlideWrapper>
      <motion.div
